...
public class SubtitutionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtitution);
        ...
        quizBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent categoryIntent=new Intent(SubtitutionActivity.this,SubtitutionActivity1.class);
...
/*
    ...
    public void onBackPressed() {
        Intent intent=new Intent(SubtitutionActivity.this,HomeActivity.class);
